...
<%--											<p>投票类型: ${vote.type.tips }</p>--%>
											...
											<c:forEach items="${vote.subjectItems }" var="subjectItem">
												<p style="background-color:white;border-radius:3px;"><label class="vote-label" for="vote_item${subjectItem.id}" data-val="${subjectItem.voteNumber}" style="margin-bottom:0px;width:100%;cursor:pointer;"><span class="item-title">${subjectItem.title}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${subjectItem.voteNumber}票</span><!--<span class="item-per item-per-${subjectItem.flag}" style="display: inline-block;width:${subjectItem.per}%;background-color:#FFA500;">&nbsp;</span>--></label></p>
											</c:forEach>
											<p>
