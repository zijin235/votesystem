...
(function(obj) {
    ...
    _zero_modal_template += '           {{#close}}<div title="close" zero-close-unique="{{unique}}" class="zeromodal-close"></div>{{/close}}';
    _zero_modal_template += '           {{#max}}<div title="max/cancel max" zero-max-unique="{{unique}}" class="zeromodal-max"></div>{{/max}}';
    _zero_modal_template += '           {{#min}}<div title="min/cancel min" zero-min-unique="{{unique}}" class="zeromodal-min"></div>{{/min}}';
    ...
    var defaultOpt = {
        ...
        cancelTitle: 'close', //“cancel”按钮的显示值，默认为“取消”
